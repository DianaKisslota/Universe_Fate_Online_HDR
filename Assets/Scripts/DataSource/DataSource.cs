...
public class DataSource : IDataSource
{
    ...
    public DataSource()
    {
        ...
        AddSector(new SectorMain1010(10, 10));  // Старт-Кладовщик
        AddSector(new SectorMain1009(10, 9));
        AddSector(new SectorMain0906(9, 06));  // Лаборатория
